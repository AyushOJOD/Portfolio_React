    ...
    <div className='w-full md:h-screen bg-[#0a192f] text-white'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          <WorkComp Image={Webpark} description={"E commerce website"} Name={"Web Park"} Demo={'https://e-commece-mern.vercel.app/'} Code={'https://github.com/AyushOJOD/E-Commece-MERN'} SampleEmail={'admin@gmail.com'} SamplePass={'Admin@1234'} />
