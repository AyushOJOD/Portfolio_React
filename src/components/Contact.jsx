    ...
    return (
        <div className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
            <form method='POST' action="https://getform.io/f/e6619a9f-2851-44ea-9e56-7ca536a2c7b0" className='flex flex-col max-w-[800px] '>
                <div className='lg:pb-3 pb-0 mt-5'>
                    <p className=' text-4xl font-bold inline border-b-4 border-pink-500 text-gray-300'>Contact</p>
                    <p className='text-gray-300 py-4'>// Reach out to me through the form or shoot me an Email - <a className='border-b-2' href="mailto: ayushsrivastava.0407@gmail.com">ayushsrivastava.0407@gmail.com</a></p>
                </div>
                ...
                <button className='text-white border-2 px-6 py-4 mx-auto my-4 flex item-center gap-2 hover:bg-pink-300 hover:text-[#0a192f] hover:font-bold duration-300 rounded-md'>Lets&apos;s Talk</button>
            </form>
        </div>
    )
}
